...
import { MetadataRefreshCommandService } from "./features/metadata/data/metadata-refresh-command.service";
...
describe("AppComponent", () => {
  ...
  let metadataRefreshCommandService: { handleBatchProgress: ReturnType<typeof vi.fn> };
  ...
  function configureComponent(
    ...
    metadataRefreshCommandService = { handleBatchProgress: vi.fn() };
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: MetadataRefreshCommandService, useValue: metadataRefreshCommandService },
  ...
  it("forwards websocket updates to the matching root services", () => {
    ...
    expect(metadataRefreshCommandService.handleBatchProgress).toHaveBeenCalledWith(
      { taskId: "task-1" },
    );
