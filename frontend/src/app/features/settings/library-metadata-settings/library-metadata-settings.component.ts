...
import {FieldOptions, MetadataRefreshOptions} from '../../metadata/model/request/metadata-refresh-options.model';
  ...
  private getDefaultMetadataOptions(): MetadataRefreshOptions {
    return {
      ...
      fieldOptions: {
        ...
        ...Object.fromEntries(this.providerFields.fields().map(field => [field.name, {p1: null, p2: null, p3: null, p4: null}])),
      } as FieldOptions
    };
  }
