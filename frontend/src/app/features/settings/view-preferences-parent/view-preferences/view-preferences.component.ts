...
import {MultiSortEditorComponent} from '../../../../shared/components/browse/multi-sort-editor.component';
...
export class ViewPreferencesComponent implements OnInit {
  ...
  readonly editorSortOptions = computed(() =>
    buildSortOptions(this.sortVocabularyQuery.data()?.sortTokens ?? []));
  ...
  private fromTerms(terms: readonly BrowseSortTerm[]): SortCriterion[] {
