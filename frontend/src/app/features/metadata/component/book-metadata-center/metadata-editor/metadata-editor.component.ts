...
import {ALL_COMIC_METADATA_FIELDS, AUDIOBOOK_METADATA_FIELDS, COMIC_FORM_TO_MODEL_LOCK, COMIC_TEXT_METADATA_FIELDS, COMIC_ARRAY_METADATA_FIELDS, COMIC_TEXTAREA_METADATA_FIELDS, isFieldEmbeddable, hasMetadataWriter, MetadataProviderFieldsService} from '../../../../../shared/metadata';
...
export class MetadataEditorComponent implements OnInit {
  ...
  private readonly providerSpecificFields = computed<MetadataProviderSpecificFields>(
    () => this.appSettingsService.appSettings()?.metadataProviderSpecificFields
      ?? this.providerFields.fields().reduce(
        (visible, field) => ({...visible, [field.name]: true}),
