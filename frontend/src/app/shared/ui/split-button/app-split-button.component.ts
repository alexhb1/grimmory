...
export class AppSplitButtonComponent {
  ...
  protected readonly isMenuDisabled = computed(() => this.disabled() || this.loading() || !this.menu());
  protected readonly menuExpanded = computed(() => (this.menu()?.isOpenState() ? 'true' : 'false'));
