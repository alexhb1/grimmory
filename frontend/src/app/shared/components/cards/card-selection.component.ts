...
const cardCheckboxInteractiveClass =
  'group-hover/card:pointer-events-auto group-hover/card:opacity-100 group-has-[:focus-visible]/card:pointer-events-auto group-has-[:focus-visible]/card:opacity-100 group-data-[active=true]/card:pointer-events-auto group-data-[active=true]/card:opacity-100 focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-primary';
