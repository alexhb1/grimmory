...
/**
 * Seeds a query with data and attaches a live observer whose fetches stay
 * pending until `finish()` is called, so specs can count refetches and aborts
 * triggered by cache reconciliation.
 */
