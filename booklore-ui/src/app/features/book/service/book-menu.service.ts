  ...
  getMoreActionsMenu(selectedBooks: Set<number>, user: User | null): MenuItem[] {
        ...
        items: Object.entries(readStatusLabels).map(([status, label]) => ({
          ...
          command: () => {
            this.confirmService.open({
              title: this.t.translate('book.menuService.confirm.readStatusHeader'),
      ...
      items.push({
        ...
        items: [
          ...AGE_RATING_OPTIONS.map(option => ({
            ...
            command: () => {
              this.confirmService.open({
                title: this.t.translate('book.menuService.confirm.ageRatingHeader'),
          ...
          },
          {
            ...
            command: () => {
              this.confirmService.open({
                title: this.t.translate('book.menuService.confirm.clearAgeRatingHeader'),
      ...
      items.push({
        ...
        items: [
          ...Object.entries(CONTENT_RATING_LABELS).map(([value, label]) => ({
            ...
            command: () => {
              this.confirmService.open({
                title: this.t.translate('book.menuService.confirm.contentRatingHeader'),
          ...
          },
          {
            ...
            command: () => {
              this.confirmService.open({
                title: this.t.translate('book.menuService.confirm.clearContentRatingHeader'),
    ...
    if (permissions?.canManageLibrary || permissions?.admin) { // Assuming these permissions cover shelf management for books
       items.push({
         ...
         command: () => {
           this.confirmService.open({
             title: this.t.translate('book.menuService.confirm.unshelveHeader'),
    ...
    if (permissions?.canBulkResetGrimmoryReadProgress ?? permissions?.canBulkResetBookloreReadProgress) {
      items.push({
        ...
        command: () => {
          this.confirmService.open({
            title: this.t.translate('book.menuService.confirm.resetHeader'),
